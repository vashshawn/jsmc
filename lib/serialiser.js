...
Serialiser.prototype.write = function write(packet) {
	...
	return !this.paused && this.writable
        ...
        console.warn('Error writing in serializer: ' + e);
	try {
            this.emit("data", S().uint8(packet.pid).mcstring16('§2An internal error occurred while writing to your client. Details:§f ' + e).result());
	}
	catch (e) {
	    console.warn('Error alerting user about serializer error: ' + e);
	}
    }
};
